...
public  class ArregloPaises {
	...
	public ArregloPaises() {
		...
		paises.add(new Paises("Perú", 0.18, 0.506, 0.757, "Sol"));
		paises.add(new Paises("Argentina", 0.21, 5.810, 3.890, "Pesos argentinos"));
		paises.add(new Paises("EE.UU", 0.11, 0.109, 0.150, "Dolar"));
